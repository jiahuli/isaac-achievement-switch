...
>
> * **代码（`main.lua`、测试、脚本、文档）由 DeepSeek 生成；mod 缩略图（`thumb.png`）由 ChatGPT 生成。** 两者随后均由人工审核，并在真实游戏环境里实测验证。
...
> * **如有侵权请联系**：本项目的文字、代码或图片若侵犯了你的权益，请在 [Issues](https://github.com/jiahuli/isaac-achievement-switch/issues) 留言（或到工坊条目留言），我会立即删除或替换相关内容。

🎮 **Steam 创意工坊订阅：<https://steamcommunity.com/sharedfiles/filedetails/?id=3799649030>**
...
**方式零：Steam 创意工坊订阅（最省事）**
👉 <https://steamcommunity.com/sharedfiles/filedetails/?id=3799649030>
订阅后进游戏在「MODS」里启用即可（仍**必须**先按下面装好忏悔龙）。
...
<游戏目录>\mods\achievement_switch\
    ├── main.lua
    ├── metadata.xml
    └── thumb.png        （创意工坊预览图，装进游戏无所谓，带着更完整）
```
...
* Install: [Steam Workshop](https://steamcommunity.com/sharedfiles/filedetails/?id=3799649030) · or drop `achievement_switch/` into `<game>/mods/`, or run `tools\install.ps1`.
...
* **Code generated by DeepSeek, thumbnail by ChatGPT, human-reviewed.** See the notice at the top. MIT licensed.
* If any part of this project (text, code or the thumbnail image) infringes your rights, please open an [issue](https://github.com/jiahuli/isaac-achievement-switch/issues) — it will be removed or replaced.
