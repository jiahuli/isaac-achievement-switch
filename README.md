...
> ## ⚠️ 声明：本项目由 ChatGPT 生成，人工审核
>
> * **代码（`main.lua`、测试、脚本、文档）以及 mod 缩略图（`thumb.png`）均由 ChatGPT 生成**，随后由人工审核并在真实游戏环境里实测验证。
...
* **Generated by ChatGPT, human-reviewed.** See the notice at the top. MIT licensed.
